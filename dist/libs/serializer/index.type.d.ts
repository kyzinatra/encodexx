...
export type TConvertValueToType<K extends TSchema> = K extends TOptionalSchema<infer OT> ? TConvertValueToType<OT> | undefined : K extends TSchemaObject ? TConvertSchemaToType<K> : K extends TArraysTypes ? TConvertValueToType<K[number]>[] : K extends TCustomType<infer CT> ? CT : never;
